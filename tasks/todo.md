...
- [x] Task 1: Introduce the versioned persistent workflow contract.
  ...
  - Files: `src/shared/contracts/workflow/`, `tests/workflow-import.test.ts`, `tests/workflow.test.ts`
...
- [x] Task 4: Replace the mock Library with API-backed workflow summaries.
  ...
  - Files: `src/features/workflow-library/`, `src/app/(product)/library/page.tsx`, `tests/library-screen.test.tsx`
...
- [x] Task 5: Add durable editor routing and loading.
  ...
  - Files: `src/app/(product)/page.tsx`, `src/app/(product)/workflows/[workflowId]/edit/`, `tests/workspace-persistence.test.tsx`
...
- [x] Task 6: Implement explicit Save and Finish behavior.
  ...
  - Files: `src/app/(product)/workflows/[workflowId]/edit/`, `src/features/workflow-editor/model/workflow.reducer.ts`, `src/features/recorder/model/useRecorderSession.ts`, `tests/workspace-persistence.test.tsx`
